...
export type ReactFiltersContextData<Context> = {
    plugins: ReactFiltersPlugins<Context,any>
    PurposeToFilterLayout: NameAnd<FilterLayout>
}
export const ReactFiltersContext = React.createContext<ReactFiltersContextData<any> | undefined>(undefined)

export type ReactFiltersProviderProps = {
    value: ReactFiltersContextData<any>
    children: React.ReactNode
}
