...
import {ErrorsOr, mapErrorsOr, ThrowError} from "@enterprise_search/errors";
...
export function findSearchTc<Context, Filters, Paging>(reportError: ThrowError, searchTcs: DatasourceNameToSearchTypeClass<Context, Filters, Paging>, datasourceName: string): SearchTypeClass<Context, Filters, Paging> {
...
export function findSearcher<Context extends SearchUsingSearcherContext<Context, Filters>, TC extends SearchTypeClass<Context, Filters, Paging>, Filters, Data, Paging>(context: Context, reportError: ThrowError, datasourceName: string, searcherType: string): Searcher<Context, TC, Filters, Data, Paging> {
...
export async function searchUsingSearcher<Context extends SearchUsingSearcherContext<Context, Filters>, Filters, Data, Paging>(context: Context, reportError: ThrowError, from: QueryDatasourceAndPaging<Filters, Paging>): Promise<ErrorsOr<SearchResult<Data, Paging>>> {
...
export async function scrollOneDataSource<Context extends SearchUsingSearcherContext<Context, Filters>, Filters, Data, Paging>(context: Context, reportError: ThrowError, existing: SearchResult<Data, Paging>, from: QueryDatasourceAndPaging<Filters, Paging>): Promise<ErrorsOr<SearchResult<Data, Paging>>> {
