...
import {OneSearch, SearchType} from "@enterprise_search/search_state";
...
export type SearchDropDownProps = { st: SearchType, onSelect: ( data: any, dataSourceName: string) => void }
